...
def export_investments_to_excel(investments: List[models.Investment]) -> BytesIO:
    ...
    for investment in investments:
        ...
        data.append({
            ...
            'Asset Class': investment.asset_class.value,
            'Investment Structure': investment.investment_structure.value,
            'Owner': investment.owner,
            'Strategy': investment.strategy,
            'Vintage Year': investment.vintage_year,
            'Commitment Amount': investment.commitment_amount,
            'Called Amount': investment.called_amount,
